...
import com.lf.tempcore.tempViews.TempCircleImageView;
...
public class TempSwipeRefreshLayout extends FrameLayout {
    ...
    public static final int LARGE = TempMaterialProgressDrawable.LARGE;
    // Maps to ProgressBar default style
    public static final int DEFAULT = TempMaterialProgressDrawable.DEFAULT;
    ...
    private TempRefreshRecyclerView.OnRefreshListener mListener;
    ...
    public void setSize(int size) {
        if (size != TempMaterialProgressDrawable.LARGE && size != TempMaterialProgressDrawable.DEFAULT) {
            return;
        }
        final DisplayMetrics metrics = getResources().getDisplayMetrics();
        if (size == TempMaterialProgressDrawable.LARGE) {
     ...
     * @param attrs
     */
    public TempSwipeRefreshLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void createProgressView() {
        mCircleView = new TempCircleImageView(getContext(), CIRCLE_BG_LIGHT, CIRCLE_DIAMETER/2);
        mProgress = new TempMaterialProgressDrawable(getContext(), this);
     ...
     * gesture.
     */
    public void setOnRefreshListener(TempRefreshRecyclerView.OnRefreshListener listener) {
        mListener = listener;
    }
