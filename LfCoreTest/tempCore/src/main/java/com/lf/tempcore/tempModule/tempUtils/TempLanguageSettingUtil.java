...
/**语言设置工具（需要在application中初始化）
 * Created by longf on 2016/7/4.
 */
public class TempLanguageSettingUtil {
    private static TempLanguageSettingUtil instance;
    ...
    private TempLanguageSettingUtil(Context paramContext) {
        //得到系统语言-
    ...
    //检验自身是否被创建-
    public static TempLanguageSettingUtil get() {
        if (instance == null)
    ...
    public static void init(Context paramContext) {
        if (instance == null) {
            instance = new TempLanguageSettingUtil(paramContext);
        }
    }
