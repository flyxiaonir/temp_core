 ...
 */
public class TempRVDividerDecoration extends RecyclerView.ItemDecoration{
    ...
    public TempRVDividerDecoration(int color, int height) {
        this.mColorDrawable = new ColorDrawable(color);
        this.mHeight = height;
    }
    public TempRVDividerDecoration(int color, int height, int paddingLeft, int paddingRight) {
        this.mColorDrawable = new ColorDrawable(color);
        this.mHeight = height;
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State state) {
        ...
        if (parent.getAdapter() instanceof TempRVCommonAdapter){
            headerCount = ((TempRVCommonAdapter) parent.getAdapter()).getHeaderCount();
            footerCount = ((TempRVCommonAdapter) parent.getAdapter()).getFooterCount();
        }
    ...
    public void onDrawOver(Canvas c, RecyclerView parent, RecyclerView.State state) {
        ...
        if (parent.getAdapter() instanceof TempRVCommonAdapter){
            headerCount = ((TempRVCommonAdapter) parent.getAdapter()).getHeaderCount();
            footerCount = ((TempRVCommonAdapter) parent.getAdapter()).getFooterCount();
            dataCount = ((TempRVCommonAdapter) parent.getAdapter()).getCount();
        }else {
