...
public class Debug {
    ...
    public static void debug(String paramString) {
        if (DEBUG){
            Log.d(TAG, paramString==null?"null":paramString);
            if(PrintLog){
...
//			Log.e(TAG, sb.toString());
    ...
    public static void info(String paramString) {
        if (DEBUG)
            Log.i(TAG, paramString==null?"null":paramString);
    }

    public static void info(String paramString1, String paramString2) {
        if (DEBUG)
            Log.i(paramString1, paramString2==null?"null":paramString2);
    }

    public static void trace(String paramString) {
        if (DEBUG)
            Log.v(TAG, paramString==null?"null":paramString);
    }

    public static void trace(String paramString1, String paramString2) {
        if (DEBUG)
            Log.v(paramString1, paramString2==null?"null":paramString2);
    }
